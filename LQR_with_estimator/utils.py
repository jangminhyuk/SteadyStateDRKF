...
# This utils.py code is downloaded from https://github.com/hanbingyan/GaussianCOT_release  for BCOT based DR Kalman filter
# Distributionally robust Kalman filtering with volatility uncertainty, Bingyan Han
